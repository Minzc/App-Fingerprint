...
IOS_STR = 'ios'
#############SQLS###############
SQL_SELECT_HTTP_PKGS = "select id, app, add_header, path, refer, hst, agent, dst, raw from %s where method=\'GET\'" 
SQL_SELECT_HTTP_PKGS_LIMIT = "select id, app, add_header, path, refer, hst, agent, dst, raw from %s where method=\'GET\' limit %s" 
