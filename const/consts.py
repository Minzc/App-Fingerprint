...
SQL_INSERT_AGENT_RULES = 'INSERT INTO patterns (host, prefix, identifier, suffix, label, support, confidence, rule_type, label_type) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s)'
SQL_DELETE_AGENT_RULES = 'DELETE FROM patterns WHERE agent IS NOT NULL and rule_type=%s'
SQL_SELECT_AGENT_RULES = 'SELECT host, prefix, identifier, suffix, label, support, confidence, rule_type, label_type FROM patterns WHERE rule_type = 3'
